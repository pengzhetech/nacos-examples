 ...
 */
package com.alibaba.nacos.example.spring.boot.env;
 ...
 */
@Configuration
@NacosPropertySource(name = "first", dataId = NacosPropertySourceConfiguration.FIRST_DATA_ID, first = true, autoRefreshed = true) // First PropertySource
@NacosPropertySources({
        @NacosPropertySource(name = "before-os-env", dataId = NacosPropertySourceConfiguration.BEFORE_OS_ENV_DATA_ID, before = SYSTEM_ENVIRONMENT_PROPERTY_SOURCE_NAME),
        @NacosPropertySource(name = "after-system-properties", dataId = NacosPropertySourceConfiguration.AFTER_SYS_PROP_DATA_ID, after = SYSTEM_PROPERTIES_PROPERTY_SOURCE_NAME)
})
public class NacosPropertySourceConfiguration {
    ...
    static {
        String serverAddr = "11.239.163.65:8848";
        try {
