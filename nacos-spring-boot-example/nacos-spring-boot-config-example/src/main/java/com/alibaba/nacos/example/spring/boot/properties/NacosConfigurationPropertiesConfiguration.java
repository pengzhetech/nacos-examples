 ...
 */
package com.alibaba.nacos.example.spring.boot.properties;
...
import static com.alibaba.nacos.example.spring.boot.domain.Pojo.DATA_ID;
...
public class NacosConfigurationPropertiesConfiguration {
    ...
    public void init() throws Exception {
        ...
        configService.publishConfig(DATA_ID, DEFAULT_GROUP, "id = 1L");
        configService.publishConfig(DATA_ID, DEFAULT_GROUP, "name = pengzhe");
